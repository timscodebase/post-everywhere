...
<div class="max-w-5xl mx-auto space-y-10 py-6 font-mono">
	<header class="space-y-3">
		...
		<p class="text-muted-foreground text-lg">Create once, publish everywhere.</p>
	</header>
		...
		<section class="lg:col-span-2 space-y-6 border border-border rounded-xl p-8 bg-secondary/10">
			...
			<div class="flex flex-col items-center justify-center h-full min-h-[300px] text-center space-y-4">
				...
				<div class="space-y-1">
					...
					<p class="text-sm text-muted-foreground max-w-[200px] mx-auto">Connect accounts in settings.</p>
				</div>
				<a href="/settings" class="text-sm text-primary font-bold hover:underline underline-offset-4 uppercase tracking-tighter">
					Settings &rarr;
				</a>
			</div>
		</section>
